...
import { motion, AnimatePresence, type PanInfo, type Transition } from "framer-motion";
...
// Bouncier spring for the center card's tap/scale feedback.
...
export function FocusRail({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[600px] w-full flex-col overflow-hidden rounded-2xl bg-neutral-950 text-white outline-none select-none",
        className
      )}
        ...
        <div className="mx-auto mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 rounded-full bg-neutral-900/80 p-1 ring-1 ring-white/10 backdrop-blur-md">
              ...
              <span
                dir="ltr"
                className="min-w-[40px] text-center text-xs font-mono text-neutral-500"
              >
                {activeIndex + 1} / {count}
              </span>
              <button
