...
>(({ title, images, stats, description, href, className, target, rel }, ref) => {
  return (
    <a
      ref={ref}
      href={href}
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="mb-6 flex items-center justify-between gap-3">
          ...
          <ArrowRight className="h-6 w-6 shrink-0 transition-transform duration-300 ease-in-out group-hover:translate-x-1" />
        </div>
